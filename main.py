...
try:
    ...
    print("\n[INTERRUPT] Keyboard interrupt detected. Shutting down gracefully...")
    # Optional: Save agents immediately on interrupt so you don't lose progress
    AgentController.save_agents("saves/interrupt", states.episodeCount)            
finally:
